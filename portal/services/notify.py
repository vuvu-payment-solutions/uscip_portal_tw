...
settings.py 需要設定：
    PA_EMAIL_WEBHOOK   = "https://prod-xx.westus.logic.azure.com/..."  # 寄信流程
    PA_TEAMS_WEBHOOK   = "https://prod-xx.westus.logic.azure.com/..."  # Teams 流程
"""
import json
import logging
...
def teams_account_approved(username: str, full_name: str):
    """CIO 審核通過 → Teams 通知"""
    return _post("PA_TEAMS_WEBHOOK", {
...
def teams_account_rejected(username: str, full_name: str, comment: str = ""):
    """申請被拒絕 → Teams 通知"""
    return _post("PA_TEAMS_WEBHOOK", {
...
def teams_new_service_application(f_no: str, a_name: str, a_type: str, service_system: str):
    """新服務申請 → Teams 通知主管"""
    return _post("PA_TEAMS_WEBHOOK", {
...
def teams_service_approved(f_no: str, a_name: str, a_type: str, service_system: str):
    """CIO 審核通過 → Teams 通知"""
    return _post("PA_TEAMS_WEBHOOK", {
...
def teams_service_rejected(f_no: str, a_name: str, comment: str = ""):
    """服務申請被拒絕 → Teams 通知"""
    return _post("PA_TEAMS_WEBHOOK", {
