...
# Sensitive URLs must be configured by environment variables or .env.
# Do not hardcode Power Automate trigger URLs in source code.
PA_TEAMS_WEBHOOK = os.environ.get('PA_TEAMS_WEBHOOK', '')
PA_EMAIL_WEBHOOK = os.environ.get('PA_EMAIL_WEBHOOK', '')
